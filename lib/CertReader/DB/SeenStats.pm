...
(
	columns => [
		...
		missing_server_hello => { type => 'integer', not_null => 0 },
		missing_client_hello => { type => 'integer', not_null => 0 },
		...
		grease_conns => { type => 'integer', not_null => 0 },
		...
		version_cipher => { type => 'varchar', not_null => 0 },
		server_versions => { type => 'varchar', not_null => 0 },
		...
		tls_signature_server => { type => 'varchar', not_null => 0 },
		...
		client_key_share_groups => { type => 'varchar', not_null => 0 },
		server_key_share_group => { type => 'varchar', not_null => 0 },
       	],
